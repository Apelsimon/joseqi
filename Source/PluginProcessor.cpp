...
JoseqiAudioProcessor::JoseqiAudioProcessor()
	...
	sampleRate(44100.f),
	bassGain(Decibels::decibelsToGain<float>(*parameters.getRawParameterValue(EqParameters::BassGainId))),
	midGain(Decibels::decibelsToGain<float>(*parameters.getRawParameterValue(EqParameters::MidGainId))),
	trebleGain(Decibels::decibelsToGain<float>(*parameters.getRawParameterValue(EqParameters::TrebleGainId))),
